...
library(wordcloud)
useSejongDic()  ## 사전이용
data1 <-readLines("박근혜대통령신년연설문_2015_01_12.txt") ## seoul_new.txt 파일을 불러옴  (행단위로 불러옴)
data1
...
data3<-gsub(" ","",data3)
data3
write(unlist(data3),"박근혜대통령신년연설문_2015_01_12_2.txt")
data4 <- read.table("박근혜대통령신년연설문_2015_01_12_2.txt")
data4
...
legend(0.3,1,"박근혜 연설문",cex=0.8,fill=NA,border=NA,bg="white",text.col="red",text.font=2,box.col="red")
